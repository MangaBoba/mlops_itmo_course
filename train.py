...
class BeansDataset(torch.utils.data.Dataset):
    def __init__(self, stage, csv_samples_info=None, transform=None):
        ...
        self.landmarks_frame = df[df['data set'] == 'train'] if stage=='train' \
            else df[df['data set'] == 'test']
    ...
    def __getitem__(self, idx):
        ...
        img_pth = self.root_dir + self.landmarks_frame.iloc[idx]['filepaths']
...
def main():
    ...
    dataset1 = BeansDataset(stage='train',csv_samples_info='clearml_dataset/data/Coffee Bean.csv', transform=transform)
    dataset2 = BeansDataset(stage='test',csv_samples_info='clearml_dataset/data/Coffee Bean.csv',transform=transform)
